...
from utils.question2 import get_sentiment, get_frequence, get_final_socre
...
if __name__ == '__main__':
    ...
    result2_2 = pd.DataFrame(result2_2, columns=['productID', 'productClass', 'product', 'final_hot', 'years'])
    result2_2.columns = ['产品ID', '产品类型', '产品名称', '产品热度', '年份']
